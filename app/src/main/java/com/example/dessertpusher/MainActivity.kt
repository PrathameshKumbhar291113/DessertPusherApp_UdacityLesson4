...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onStart() {
        super.onStart()
        Timber.i("on Start is called")
    }

    override fun onResume() {
        super.onResume()
        Timber.i("on Resume is called")
    }

    override fun onRestart() {
        super.onRestart()
        Timber.i("on Restart is called")
    }

    override fun onPause() {
        super.onPause()
        Timber.i("on Pause is called")
    }

    override fun onStop() {
        super.onStop()
        Timber.i("on Stop is called")
    }

    override fun onDestroy() {
        super.onDestroy()
        Timber.i("on Destroy is called")
    }
}
